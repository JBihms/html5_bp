namespace WebProject1.Framework
{
    ...
    /// This filter redirects all non-canonical URL's based on the settings specified to their canonical equivalent. 
    ...
    public class RedirectToCanonicalUrlAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        /// <param name="lowercaseUrls">If set to <c>true</c> lowercase all URL's.</param>
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            // Ignore the Elmah and Error pages.
            string controllerName = filterContext.ActionDescriptor.ControllerDescriptor.ControllerName;
            if (string.Equals(controllerName, ControllerName.Elmah, StringComparison.Ordinal) ||
                string.Equals(controllerName, ControllerName.Error, StringComparison.Ordinal))
            {
                return;
            }
        ...
        /// <returns><c>true</c> if a <see cref="NoTrailingSlashAttribute"/> attribute is specified, otherwise <c>false</c>.</returns>
